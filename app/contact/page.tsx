...
export const metadata: Metadata = {
  title: "Contact Us",
  description:
    "Get in touch with the Rotary Club of Ely. We meet most Thursdays at 8pm at The City of Ely Bowls Club. New visitors always welcome.",
  openGraph: {
      ...
      <section className="bg-rotary-blue-dark py-20 pt-36">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 text-lg text-white/80 max-w-xl">
            Whether you're curious about joining, have a question about our
            events, or want to explore a partnership — we'd love to hear from
            you.
          </p>
        </div>
      </section>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-rotary-blue rounded-2xl p-6 shadow-sm">
                ...
                <p className="text-white/80 text-sm leading-relaxed mb-4">
                  You're welcome to come along to a Thursday meeting as a guest
                  before making any commitment. Just drop us a message and we'll
                  make sure you're expected.
                </p>
